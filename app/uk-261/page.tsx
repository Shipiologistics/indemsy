                    ...
                    <div className={styles.content}>
                        ...
                        <section id="montant" className={styles.section}>
                            ...
                            <div className={styles.compensationGrid}>
                                ...
                                <div className={styles.compensationItem}>
                                    <div className={styles.compensationIcon}>£</div>
                                    <div className={styles.compensationText}><strong>{t('sections.montant.val3')}</strong> {t('sections.montant.l3')}</div>
                                </div>
                            </div>
                        </section>
                        ...
                        <section id="etapes" className={styles.section}>
                            <h2 className={styles.sectionTitle}>{t('sections.etapes.title')}</h2>
                            <p>{t('sections.etapes.p1')}</p>
