...
export default function Footer() {
    ...
    useEffect(() => {
        const fetchSocials = async () => {
            try {
                const { getSocialLinks } = await import('@/app/actions/socials');
    ...
    const navbarLinks = {
        // ... (keep this if it was here, but in original view it wasn't shown, only footerLinks)
        // Actually, only footerLinks variable was shown. I won't re-declare it if I don't touch it.
    };
