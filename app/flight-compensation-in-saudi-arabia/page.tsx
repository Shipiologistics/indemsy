...
export default function SaudiRightsPage() {
    const t = useTranslations('saudiRights');
                ...
                <div className={styles.pageGrid}>
                    ...
                    <div className={styles.content}>
                        ...
                        <section id="montant" className={styles.section}>
                            ...
                            <div className={styles.sectionContent}>
                                <p>{t('sections.montant.p1')}</p>
                            </div>
                        </section>

                        <section id="assistance" className={styles.section}>
                            <h2 className={styles.sectionTitle}>{t('sections.assistance.title')}</h2>
                            <div className={styles.sectionContent}>
                                <p>{t('sections.assistance.p1')}</p>
                            </div>
                        </section>
