            ...
            <div className={styles.container}>
                <div className={styles.content}>
                    ...
                    <div className={styles.trustBadge}>
                        ...
                        <span className={styles.trustExcellent}>Excellent</span>
                        ...
                        <span className={styles.trustCount}>229,858 reviews</span>
                    </div>

                    {/* Title */}
                    <h1 className={styles.title}>
                        Delayed or canceled flight?
                        <span className={styles.highlight}>Get up to $650!</span>
                    </h1>

                    {/* Subtitle */}
                    <p className={styles.subtitle}>
                        You've got rights when your flight's disrupted. We enforce them and handle everything so you get paid.
                    </p>
                    ...
                    <div className={styles.glassContainer}>
                        ...
                        <div className={styles.fastCheck}>
                            <span className={styles.fastCheckLabel}>or fast check with</span>
                            <button className={styles.boardingPassBtn}>
